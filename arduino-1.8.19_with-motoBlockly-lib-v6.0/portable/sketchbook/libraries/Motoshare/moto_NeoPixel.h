...
#ifndef moto_NEOPIXEL_H
#define moto_NEOPIXEL_H
...
// the same item.  The third parameter to the moto_NeoPixel
...
class moto_NeoPixel {
 ...
 public:
  ...
  moto_NeoPixel(uint16_t n, uint8_t p=6, neoPixelType t=NEO_GRB + NEO_KHZ800);
  moto_NeoPixel(void);
  ~moto_NeoPixel();
