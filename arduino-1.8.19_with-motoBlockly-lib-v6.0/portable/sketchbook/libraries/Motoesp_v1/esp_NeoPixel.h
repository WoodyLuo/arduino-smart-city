...
#ifndef esp_NEOPIXEL_H
#define esp_NEOPIXEL_H
...
// the same item.  The third parameter to the esp_NeoPixel
...
class esp_NeoPixel {
 ...
 public:
  ...
  esp_NeoPixel(uint16_t n, uint8_t p=6, neoPixelType t=NEO_GRB + NEO_KHZ800);
  esp_NeoPixel(void);
  ~esp_NeoPixel();
