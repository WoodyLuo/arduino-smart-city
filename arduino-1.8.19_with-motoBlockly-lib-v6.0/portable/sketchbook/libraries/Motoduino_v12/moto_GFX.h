...
/// A generic graphics superclass that can handle all sorts of drawing. At a minimum you can subclass and provide drawPixel(). At a maximum you can do a ton of overriding to optimize. Used for any/all moto displays!
class moto_GFX : public Print {

 public:

  moto_GFX(int16_t w, int16_t h); // Constructor
  ...
  // These exist only with moto_GFX (no subclass overrides)
  void
...
class moto_GFX_Button {

 public:
  moto_GFX_Button(void);
  // "Classic" initButton() uses center & size
  void initButton(moto_GFX *gfx, int16_t x, int16_t y,
  ...
  void initButtonUL(moto_GFX *gfx, int16_t x1, int16_t y1,
   uint16_t w, uint16_t h, uint16_t outline, uint16_t fill,
   uint16_t textcolor, char *label, uint8_t textsize);
  void initButtonUL(moto_GFX *gfx, int16_t x1, int16_t y1,
   uint16_t w, uint16_t h, uint16_t outline, uint16_t fill,
...
class GFXcanvas1 : public moto_GFX {
 public:
...
class GFXcanvas8 : public moto_GFX {
 public:
...
class GFXcanvas16 : public moto_GFX {
 public:
