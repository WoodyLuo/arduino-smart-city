...
class moto_SH1106 : public moto_GFX {
 public:
  moto_SH1106(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS);
  moto_SH1106(int8_t DC, int8_t RST, int8_t CS);
  moto_SH1106(int8_t RST);
  ~moto_SH1106(void);
